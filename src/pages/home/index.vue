                ...
                <div class="guide-con">
                    ...
                    <div class="guide-card guide-card2">
                        ...
                        <Button
                            type="primary"
                            class="btn click-btn"
                            @click={jumpTo.bind(this, 'bridge-con')}
                        >
                            CLICK
                        </Button>
                    </div>
...
export default {
  ...
  data() {
    return {
      goldCoinsImg:goldCoinsImg,
      bg2Img:bg2Img,
      mmLogoImg:mmLogoImg,
      iconGoogleLogoImg:iconGoogleLogoImg,
      iconChromeLogoImg:iconChromeLogoImg,
      iconAppleLogoImg:iconAppleLogoImg,
      appExImg:appExImg,
